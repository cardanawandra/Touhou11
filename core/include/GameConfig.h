...
struct GameConfig
{
    ...
    uint8_t  displayMode;      // <0x1D> 0 = fullscreen 640480
    //       1 = window 640480
    //       2 = window 960720
    //       3 = window 1280960
    ...
    // --------------------------------------------------------------------
    uint32_t flags;
    //  bit 0 (0x0001) :  Use 16-bit textures
    //  bit 1 (0x0002) :  Force reference rasterizer
    //  bit 2 (0x0004) :  Disable fog
    //  bit 3 (0x0008) :  Do not use DirectInput for pad/keyboard
    //  bit 4 (0x0010) :  Load BGM into memory
    //  bit 5 (0x0020) :  Disable V-Sync
    //  bit 6 (0x0040) :  Do not auto-detect text rendering env
